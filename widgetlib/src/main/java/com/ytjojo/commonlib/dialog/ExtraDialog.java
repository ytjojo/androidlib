...
public class ExtraDialog extends Dialog {
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setPositiveButton(int positiveButtonText, OnClickListener listener,int id) {
         ...
         * @return
         */
        public Builder setPositiveButton(String positiveButtonText, OnClickListener listener ,int id) {
         ...
         * @return
         */
        public Builder setNegativeButton(int negativeButtonText, OnClickListener listener,int id) {
         ...
         * @return
         */
        public Builder setNegativeButton(String negativeButtonText, OnClickListener listener,int id) {
