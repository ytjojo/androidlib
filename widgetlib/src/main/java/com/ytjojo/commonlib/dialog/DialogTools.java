package com.ytjojo.commonlib.dialog;
...
public class DialogTools {
	 ...
	 * @return
	 */
	public static Dialog createDialog(Context ctx, int iconId, String title, String message, String btnName, OnClickListener listener) {
		Dialog dialog = null;
	 ...
	 * @return 对话框实现
	 */
	public static Dialog createDialog(Context ctx, int iconId, String title, String message, String btnPositiveName, OnClickListener listener_Positive,
			String btnNegativeName, OnClickListener listener_Negative) {
		Dialog dialog = null;
		Builder builder = new Builder(ctx);
		// 设置对话框的图标
		builder.setIcon(iconId);
	 ...
	 * @return
	 */
	public static Dialog createCheckBoxDialog(Context ctx, int iconId, String title, int itemsId, boolean[] flags, DialogInterface.OnMultiChoiceClickListener listener, String btnName,
			OnClickListener listener2) {
		Dialog dialog = null;
		Builder builder = new Builder(ctx);
		// 设置对话框的图标
...
//	}
	...
	public static Dialog createSelfDialog(Context context,int iconId,String title, View view,OnClickListener negativelistener,OnClickListener positivelistener) {
		builder = new Builder(context);
		builder.setCancelable(true);
		builder.setIcon(iconId);
		builder.setTitle(title);
