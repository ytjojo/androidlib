package com.ytjojo.commonlib.utill;
...
//      boolean network = locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER);
    ...
    public static boolean isNetworkRoaming(Context context) {
        ...
        if (connectivity == null) {
           Log.i("NetChecker", "couldn't get connectivity manager");
        } else {
            NetworkInfo info = connectivity.getActiveNetworkInfo();
            if (info != null
                ...
                if (tm != null && tm.isNetworkRoaming()) {
                    Log.i("NetChecker",  "network is roaming");
                    return true;
                } else {
                    Log.i("NetChecker",  "network is not roaming");
                }
            } else {
                Log.i("NetChecker",  "not using mobile network");
            }
        }
        return false;
    }
